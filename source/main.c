...
*
* Update: 31-Jan-2022 (DJJW)
* 	- Created New Application using Quick Panel "New Application"
* 	- Selected CY8CPROTO-062-4343W BSP
* 	- Corrected bug in led.c - #define GET_DUTY_CYCLE(x) (101 - x)
*
*
*******************************************************************************
...
//    cy_rslt_t result;
    ...
    for (;;)
    {
        if (capsense_scan_complete)
        {
        	...
        	/* check sensors for abnormal behavior */
        	result = checkSensor(ALL_SENSORS, true);
